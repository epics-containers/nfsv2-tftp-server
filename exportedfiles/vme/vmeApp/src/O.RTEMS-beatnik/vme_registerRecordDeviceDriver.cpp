...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devAiHy8401ip,
    ...
    *pvar_dset_devBoDbState, *pvar_dset_devBoHy8401ip,
    ...
    *pvar_dset_devLiGeneralTime, *pvar_dset_devLonginHy8401ip,
    *pvar_dset_asynLiInt32, *pvar_dset_asynLiUInt32Digital,
    *pvar_dset_asynLiInt64, *pvar_dset_devLoSoft,
    *pvar_dset_devLoSoftCallback, *pvar_dset_devLongoutHy8401ip,
    ...
    *pvar_dset_devWfSoft, *pvar_dset_devWfHy8401ip,
...
static const char * const deviceSupportNames[] = {
    ...
    "devLonginHy8401ip", "asynLiInt32", "asynLiUInt32Digital",
    "asynLiInt64", "devLoSoft", "devLoSoftCallback", "devLongoutHy8401ip",
    ...
    "devWfSoft", "devWfHy8401ip", "asynWfOctetCmdResponse",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiHy8401ip, pvar_dset_asynAiInt32,
    ...
    pvar_dset_devAoSoftCallback, pvar_dset_asynAoInt32,
    pvar_dset_asynAoFloat64, pvar_dset_asynAoInt64, pvar_dset_devHy8402ip,
    pvar_dset_devHy8402ip, pvar_dset_asynRecordDevice,
    pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_devBiHy8401ip, pvar_dset_asynBiInt32,
    ...
    pvar_dset_devBoHy8401ip, pvar_dset_asynBoInt32,
    ...
    pvar_dset_devLonginHy8401ip, pvar_dset_asynLiInt32,
    pvar_dset_asynLiUInt32Digital, pvar_dset_asynLiInt64,
    pvar_dset_devLoSoft, pvar_dset_devLoSoftCallback,
    pvar_dset_devLongoutHy8401ip, pvar_dset_asynLoInt32,
    ...
    pvar_dset_devWfHy8401ip, pvar_dset_asynWfOctetCmdResponse,
...
epicsShareExtern drvet *pvar_drvet_drvAsyn, *pvar_drvet_drvHy8401ip,
    *pvar_drvet_drvHy8402ip, *pvar_drvet_drvIpac;

static const char *driverSupportNames[] = {
    "drvAsyn", "drvHy8401ip", "drvHy8402ip", "drvIpac"};

static struct drvet *drvsl[] = {
    pvar_drvet_drvAsyn,
    pvar_drvet_drvHy8401ip,
    pvar_drvet_drvHy8402ip,
    pvar_drvet_drvIpac};
...
epicsShareExtern reg_func pvar_func_Hy8002Registrar,
    pvar_func_Hy8401ipRegistrar, pvar_func_Hy8402ipAsynRegistrar,
    pvar_func_Hy8402ipRegistrar, pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_ipacRegistrar, pvar_func_rsrvRegistrar,
...
int vme_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/dls_sw/work/common/hir12111/rtems-in-vme/vme";
    ...
    runRegistrarOnce(pvar_func_Hy8002Registrar);
    runRegistrarOnce(pvar_func_Hy8401ipRegistrar);
    runRegistrarOnce(pvar_func_Hy8402ipAsynRegistrar);
    runRegistrarOnce(pvar_func_Hy8402ipRegistrar);
...
/* vme_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"vme_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(vme_registerRecordDeviceDriver(*iocshPpdbbase));
}
